...
var date = new MyDate();
dwn(date.toGMTString); //undefined，date并没有继承到Date类型，所以没有toGMTString方法 

// 核心对象的某些方法不能被构造继承，原因是核心对象并不像我们自定义的一般对象那样在构造函数里进 行赋值或初始化操作 
// 换成原型继承法呢？，如下： 

function MyDate() {}
MyDate.prototype = new Date();
var date = new MyDate();
dwn(date.toGMTString); //'[object]'不是日期对象，仍然没有继承到Date类型！ 
